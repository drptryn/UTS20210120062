...
import 'dashbord1_model.dart';
export 'dashbord1_model.dart';

class Dashbord1Widget extends StatefulWidget {
  const Dashbord1Widget({Key? key}) : super(key: key);

  @override
  _Dashbord1WidgetState createState() => _Dashbord1WidgetState();
}

class _Dashbord1WidgetState extends State<Dashbord1Widget> {
  late Dashbord1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Dashbord1Model());
                                                    ...
                                                    child: ClipRRect(
                                                      borderRadius:
                                                          BorderRadius.circular(
                                                              8),
                                                      child: Image.asset(
                                                        'assets/images/089512475723.png',
                                                        width: 160,
                                                        height: 195,
                                                        fit: BoxFit.cover,
                                                      ),
